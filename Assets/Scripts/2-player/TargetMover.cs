...
public class TargetMover: MonoBehaviour {
    ...
    //private TilemapGraphAStar tilemapGraph = null;
    ...
    private void MakeOneStepTowardsTheTarget() {
        ...
        //List<object> shortestPath = Astar.GetPath(tilemapGraph, startNode, endNode, maxIterations);
        Debug.Log("shortestPath = " + string.Join(" , ",shortestPath));
        if (shortestPath.Count >= 2) {
            Vector3Int nextNode = (Vector3Int)shortestPath[1];
